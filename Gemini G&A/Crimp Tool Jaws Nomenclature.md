...
## 02: Referenece to the AWG of teh terminal
## F: Purpose, in this case an F-Crimp
...
###     Bootlace ferrule crimpers: Designed for bootlace ferrules/cord end terminals.
###     RJ45/Network crimping tools: For use with modular network and phone connectors.
###     Coaxial crimpers: For specific coaxial cable and contact types.
###     Ring/Spade/Butt connector crimpers: For specific insulated or non-insulated terminal shapes.
##  Wire Gauge (AWG/mm²): The size of the wire the tool is rated for is a crucial identifier.
###     For insulated terminals, a color-coding system is widely used and mirrored on the tool's dies:
####        Red: 22-18 AWG (small gauge).
####        Blue: 16-14 AWG (medium gauge).
####        Yellow: 12-10 AWG (large gauge).
###     Non-insulated terminals for larger wires are often marked with specific gauge sizes (e.g., 8 AWG, 4 AWG).
##  Crimp Profile/Die Shape: The shape of the resulting crimp is a major factor. Tool dies are designed for specific profiles:
###     Hexagonal or Square for wire ferrules and heavy-duty lugs.
###     Oval or Indent for closed-barrel terminals.
###     F-crimp profile for open-barrel terminals.
